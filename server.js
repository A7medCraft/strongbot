...
setInterval(() => {
  http.get(`http://strongbota.glitch.me/`);
}, 280000);
...
client.on('message', msg => {  
    if (msg.content === '-inv') {  
      msg.reply('**https://discord.com/api/oauth2/authorize?client_id=755339224349147167&permissions=8&scope=bot**');  
    }
  });
...
client.login('NzU1MzM5MjI0MzQ5MTQ3MTY3.X2B2eA.ph_XO6QfGKO24AM4ANV-3UjeCNA');
